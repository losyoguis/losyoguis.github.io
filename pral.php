	...
	<div class="container">
		...
		<div class="row mt-3">
			<div class="col">
				<div class="card">
					<div class="card-body">
						<h1 class="mb-3">PRAL</h1>
						<p>	Proyecto de Reutilización de Aguas Lluvias </p>
		...
		<div class="row">
			<div class="col">
				...
				<div class="embed-responsive embed-responsive-16by9">
					<iframe width="560" height="315" src="https://www.youtube.com/embed/Fa63vl9BN3w" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
				</div>
							</div>
		</div>
		...
		<footer class="row">
			<div class="col">
				...
				<h4>Proyecto de Reutilización de Aguas Lluvias</h4>
				<p>2019 - 2020</p>
			</div>
		</footer>
	</div>
